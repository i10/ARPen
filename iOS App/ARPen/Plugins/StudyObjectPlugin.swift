//
//  StudyObjectPlugin.swift
//  ARPen
//
//  Created by Martin on 07.12.19.
...
class StudyObjectPlugin: Plugin, UserStudyRecordPluginProtocol {
        ...
        if pressed3 {
            if let startingPoint = self.startingPoint {
                ...
                if !objectCurrentlyBuilding{
                    ...
                    case 0:
                        // flat corner small
                        let objectNode = generateObject(size: 1, shape: 1, corner: 3, startingPoint: scene.pencilPoint.position, scene: scene)
                        break
                    case 1:
                    // flat corner large
                        let objectNode = generateObject(size: 2, shape: 1, corner: 3, startingPoint: scene.pencilPoint.position, scene: scene)
                        break
                    case 2:
                    // exterior corner small
                        let objectNode = generateObject(size: 1, shape: 1, corner: 1, startingPoint: scene.pencilPoint.position, scene: scene)
                        break
                    case 3:
                    // exterior corner large
                        let objectNode = generateObject(size: 2, shape: 1, corner: 1, startingPoint: scene.pencilPoint.position, scene: scene)
                        break
                    case 4:
                    // interior corner small
                        let objectNode = generateObject(size: 1, shape: 1, corner: 2, startingPoint: scene.pencilPoint.position, scene: scene)
                        break
                    default:
                    // interior corner large
                        let objectNode = generateObject(size: 2, shape: 1, corner: 2, startingPoint: scene.pencilPoint.position, scene: scene)
                        break
                    }
//
